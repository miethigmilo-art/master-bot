...
class IBKRAdapter extends BrokerAdapter {
  ...
  _initIB() {
    ...
    try {
      ...
      conM������ɽȠ�m%	-It�������������Ѽ�����ȁ���������٥��ȁչѥ�����х��������(������ѡ�̹}ɕ��ɑ�ɽȠ����ձ�}���ͥ����ѽŕ佥���P��ո��������х����ѽŕ佥����(������ɕ��ɸ�(�����((����ѡ�̹}%	�յ̀��=ɑ���ѥ����=ɑ��Q�����M��Q������((��������Ё���􁹕܁%	���쁡����ѡ�̹}���а������ѡ�̹}���а�������%��ѡ�̹}������%�����(����ѡ�̹}���􁥈�((����������ٕ��9����������ѕ����������(������ѡ�̹}������ѕ�����Ք�(������ѡ�̹}ɕ�����������������(���������ͽ��������m%	-It������ѕ���H���ѡ�̹}�������ѡ�̹}��������(������ѡ�̹���Р��ɽ���}�ٕ�М�������耝������ѕ��������ѕ�耝���Ȝ����聹�܁�є���ѽ%M=M�ɥ��������(���������ɕ�%�̠Ĥ�(���������ɕ�A�ͥѥ��̠��(����������ѡ�̹}����չФ(�����������ɕ����չ�Mյ����İ��������Q�х��͡Y��Ք�9��1��ե��ѥ���م������չ�̜��(�������((����������ٕ��9������͍�����ѕ����������(������ѡ�̹}������ѕ��= false;
